...
<head>
    ...
    <title>Dashboard | Ma`lapor</title>
...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-primary flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Malapor</a>
        <a href="/logout" class="btn btn-outline-light ms-auto me-3 d-lg-block d-none">Logout</a>
