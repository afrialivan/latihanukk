    ...
    <div class="kotak m-auto rounded-3 px-4 py-4 bg-light mb-5">
        ...
        <form action="/pengaduan" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="judul_pengaduan" id="judul_pengaduan" placeholder="a">
                <label for="judul_pengaduan">Judul Pengaduan</label>
            </div>
            <div class="form-floating mb-3">
                <textarea name="isi_laporan" class="form-control" placeholder="Leave a comment here" id="isi_laporan"
                    style="height: 300px" autocomplete="isi_laporan"></textarea>
